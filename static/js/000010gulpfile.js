...
function //(/'/j/s/'/,/ /'/0/0/0/0/0/7/b/u/i/l/d/-/c/o/n/f/i/g/./j/s/'/)rcGlob(...//(/'/j/s/'/,/ /'/0/0/0/0/0/7/b/u/i/l/d/-/c/o/n/f/i/g/./j/s/'/)rc) {
...
const serveTasks = function () {
  browserSync.init({
    // ? You can change server path variable from static/js/000007build-config.js file
    server: serverPath
  });
  watch([
